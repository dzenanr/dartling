...
String genApp(Repo repo) {
  ...
  sc = '${sc}#source("../dartling.dart/view/component/entities.dart"); \n';
  sc = '${sc}#source("../dartling.dart/view/component/entity.dart"); \n';
  sc = '${sc}#source("../dartling.dart/view/component/param.dart"); \n';
  sc = '${sc}#source("../dartling.dart/view/component/repo.dart"); \n';
  sc = '${sc} \n';
