...
String genApp(Repo repo) {
  ...
  sc = '${sc}#source("view/home/menu.dart"); \n';
  sc = '${sc} \n';
  ...
  for (Domain domain in repo.domains) {
    sc = '${sc}showData(${domain.code}Repo ${domain.codeFirstLetterLower}Repo) { \n';
    sc = '${sc}   var ${domain.codeFirstLetterLower}Models = \n';
    sc = '${sc}       ${domain.codeFirstLetterLower}Repo.'
         'getDomainModels(${domain.code}Repo.'
         '${domain.codeFirstLetterLower}DomainCode); \n';
    ...
    for (Model model in domain.models) {
      ...
      sc = '${sc}       ${domain.codeFirstLetterLower}Models.'
           ...
           '${domain.codeFirstLetterLower}'
           '${model.code}ModelCode); \n';
      sc = '${sc}  var viewList = new List<View>(); \n';
      sc = '${sc} \n';
      for (Concept concept in model.entryConcepts) {
        sc = '${sc}  ${concept.codes} ${concept.codesFirstLetterLower} = '
             '${domain.codeFirstLetterLower}${model.code}Entries.'
             '${concept.codesFirstLetterLower}; \n';
        sc = '${sc}  var ${concept.codesFirstLetterLower}View = '
             'new View(document, "${concept.codesFirstLetterLower}"); \n';
        sc = '${sc}  ${concept.codesFirstLetterLower}View.entities = '
             '${concept.codesFirstLetterLower}; \n';
        sc = '${sc}  ${concept.codesFirstLetterLower}View.title = '
             '${concept.codesFirstLetterLower}.concept.codes; \n';
        sc = '${sc}  viewList.add(${concept.codesFirstLetterLower}View); \n';
        sc = '${sc} \n';
      }
      sc = '${sc}  new MenuBar(document, viewList); \n';
    }
  }
  sc = '${sc}} \n';
  sc = '${sc} \n';
  ...
  for (Domain domain in repo.domains) {
    ...
    sc = '${sc}  showData(${domain.codeFirstLetterLower}Repo); \n';
  }
  sc = '${sc}} \n';
  sc = '${sc} \n';
