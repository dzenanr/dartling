...
#source("../lib/data/art/pen/json/data.dart");
#source("../lib/data/art/pen/json/model.dart");
#source("../lib/data/art/pen/init.dart");
#source("../lib/data/art/pen/segments.dart");
#source("../lib/data/art/pen/lines.dart");

#source("../lib/data/gen/art/pen/entries.dart");
#source("../lib/data/gen/art/pen/segments.dart");
#source("../lib/data/gen/art/pen/lines.dart");
#source("../lib/data/gen/art/models.dart");
#source("../lib/data/gen/art/repository.dart");

#source("../lib/data/art/pen/pen.dart");
#source("../lib/data/art/pen/examples.dart");
#source("../lib/data/art/pen/programs.dart");

#source("../lib/util/color.dart");
#source("../lib/util/random.dart");

#source("../lib/view/drawing.dart");
#source("../lib/view/program.dart");
